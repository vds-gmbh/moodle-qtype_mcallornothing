...
/**
 * Provides the information to backup mcallornothing questions.
 *
 * @package    qtype_mcallornothing
 * @copyright  2010 onwards Eloy Lafuente (stronk7) {@link http://stronk7.com}
 * @copyright  2026 onwards VdS Schadenverhütung
...
class backup_qtype_mcallornothing_plugin extends backup_qtype_plugin {
    ...
    protected function define_question_plugin_structure() {
        ...
        $plugin = $this->get_plugin_element(null, '../../qtype', 'mcallornothing');
        ...
        $mcallornothing = new backup_nested_element('mcallornothing', ['id'], [
        ...
        $mcallornothing->set_source_table('qtype_mcallornothing_options', ['questionid' => backup::VAR_PARENTID]);
