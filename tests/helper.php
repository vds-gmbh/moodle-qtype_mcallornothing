 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_mcallornothing_test_helper {
    /**
    ...
    /**
     * Makes a mcallornothing question with 2 correct answers.
     *
     * @return qtype_mcallornothing_question
     */
    public function make_mcallornothing_question_two_of_four() {
        question_bank::load_question_definition_classes('mcallornothing');
        $mc = new qtype_mcallornothing_question();
        ...
        $mc->qtype = question_bank::get_qtype('mcallornothing');
        $mc->shuffleanswers = 1;
     ...
     * @return object
     */
    public static function get_mcallornothing_question_data_two_of_four() {
        global $USER;
     ...
     * @return object
     */
    public static function get_mcallornothing_question_form_data_two_of_four() {
        $qdata = new stdClass();
