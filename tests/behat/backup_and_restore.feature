...
Feature: Test duplicating a quiz containing a All-or-Nothing Multiple Choice question
  ...
  @javascript
  Scenario: Backup and restore a course containing a All-or-Nothing Multiple Choice question
    ...
    And I choose "Edit question" action for "All-or-nothing-001" in the question bank
