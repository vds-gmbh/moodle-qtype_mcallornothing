 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_mcallornothing_walkthrough_test extends qbehaviour_walkthrough_test_base {

    public function test_deferredfeedback_feedback_mcallornothing() {
        // Create a mcallornothing question.
        $mc = $dd = test_question_maker::make_question('mcallornothing');
    ...
    public function test_deferredfeedback_resume_mcallornothing_right_right() {
