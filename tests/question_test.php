...
class qtype_mcallornothing_question_test extends advanced_testcase {
     ...
     * @return qtype_mcallornothing_question the requested question object.
     */
    protected function get_test_mcallornothing_question($which = null) {
        return test_question_maker::make_question('mcallornothing', $which);
    }
    ...
    public function test_get_question_summary() {
        $mc = $this->get_test_mcallornothing_question('two_of_four');
