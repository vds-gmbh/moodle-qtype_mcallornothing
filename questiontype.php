 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_mcallornothing extends question_type {
    /**
    ...
    protected function create_default_options($question) {
        ...
        $config = get_config('qtype_mcallornothing');
    ...
    public function save_question_options($question) {
        ...
        $options = $DB->get_record('qtype_mcallornothing_options', ['questionid' => $question->id]);
        if (!$options) {
            $options = new stdClass();
            $options->questionid = $question->id;
            ...
            $options->showstandardinstruction = 0;
            $options->id = $DB->insert_record('qtype_mcallornothing_options', $options);
        }
        ...
        $DB->update_record('qtype_mcallornothing_options', $options);
    ...
    protected function make_question_instance($questiondata) {
        ...
        $class = 'qtype_mcallornothing_question';
        return new $class();
    }
    ...
    public function delete_question($questionid, $contextid) {
        global $DB;
        $DB->delete_records('qtype_mcallornothing_options', ['questionid' => $questionid]);
    ...
    public function import_from_xml($data, $question, qformat_xml $format, $extra = null) {
        ...
        if (!isset($data['@']['type']) || $data['@']['type'] != 'mcallornothing') {
            return false;
        }
